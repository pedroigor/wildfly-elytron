 ...
 */
public class SetOAuth2ClientCredentialsConfiguration extends AuthenticationConfiguration {
     ...
     */
    SetOAuth2ClientCredentialsConfiguration(URI tokenEndpointUri, String clientId, String clientSecret, String scopes) {
    ...
    /**
     * Creates a new instance with a parent config.
     *
     ...
     * @param scopes           a string with the scope of the access request
     */
    SetOAuth2ClientCredentialsConfiguration(AuthenticationConfiguration parent, URI tokenEndpointUri, String clientId, String clientSecret, String scopes) {
        super(parent);
        this.tokenEndpointUri = checkNotNullParam("tokenEndpointUri", tokenEndpointUri);
        this.clientId = checkNotNullParam("clientId", clientId);
        this.clientSecret = checkNotNullParam("clientSecret", clientSecret);
    ...
    AuthenticationConfiguration reparent(AuthenticationConfiguration newParent) {
        return new SetOAuth2ClientCredentialsConfiguration(newParent, tokenEndpointUri, clientId, clientSecret, scopes);
    }
}
