...
public final class HttpClient {
    ...
    public static final class HttpRequest {
         ...
         * @throws RuntimeException in case any unexpected error occurs when executing the request
         */
        public void execute(BiConsumer<InputStream, Throwable> responseHandler) throws RuntimeException {
            execute(new BiFunction<InputStream, Throwable, Void>() {
                @Override
                public Void apply(InputStream inputStream, Throwable throwable) {
                    responseHandler.accept(inputStream, throwable);
                    return null;
                }
            });
        }
